...
export const otherSystems = [
  ...
  { n: "07", name: "Indus HRM & MIS", desc: "HR management and management-information web applications in the same product family.", stack: [".NET", "SQL Server"] },
  { n: "08", name: "TaskMate", desc: "Side project. React Native task app with local SQLite, scheduled notifications and natural-language dates.", stack: ["Expo", "NativeWind", "expo-sqlite"] },
];
