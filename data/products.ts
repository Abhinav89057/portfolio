...
export const otherSystems = [
  ...
  { n: "05", name: "Master Import Tool", desc: "Excel to SQL Server import for a 2,100-row materials master with case-insensitive dedupe, transactional upsert and stock fan-out across production units.", stack: ["Next.js 16", ".NET 10", "SqlClient"] },
  { n: "06", name: "IndusDB Tool", desc: "Desktop database utility migrated from VB6. Creates schema script archives and applies updates to one or many targets. Ships as a single-file executable.", stack: ["Python", "PyQt6", "pyodbc", "PyInstaller"] },
  { n: "07", name: "KhetFlow", desc: "Offline-first PWA for a shade-net farm in Rajasthan. Tracks every crop cycle from seed purchase to sale: ledger with bill photos, weighted-average inventory costing, per-cycle profit and ROI, receivables with aging. Dexie on device, custom sync engine to Supabase. Hindi / English UI.", stack: ["Next.js", "Dexie", "Supabase", "PWA"] },
  { n: "08", name: "Custom AI agents", desc: "Purpose-built agents and MCP servers that plug LLMs into real systems: tool-calling agents over backend APIs and SQL Server, browser-automation agents, and agentic coding workflows with Claude Code and Codex.", stack: ["OpenAI", "MCP", "Claude Code", "Playwright"] },
];
